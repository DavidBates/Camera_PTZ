...
cp PTZControl_Mac/USBBridge.c PTZControl_Mac/USBBridge.h PTZControl_Mac/UVCDescriptors.swift PTZControl_Mac/ZoomState.swift PTZControl_Mac/PTZCameraController.swift PTZControl_Mac/USBTransport.swift PTZControl_Mac/USBCameraControl.swift "$task_build_dir/"
...
sources=("$task_build_dir/ZoomState.swift" "$task_build_dir/UVCDescriptors.swift" "$task_build_dir/PTZCameraController.swift" "$task_build_dir/USBTransport.swift" "$task_build_dir/USBCameraControl.swift")
